  ...
  const skillsData = [
    {
      category: 'Languages',
      icon: Code,
      skills: ['Java', 'Python', 'TypeScript', 'JavaScript', 'C#', 'SQL', 'HTML5', 'CSS3'],
    },
    {
      category: 'Frameworks & Libraries',
      icon: Layout,
      skills: [
        'Spring Boot (Security, Data JPA, Batch, Cloud, WebClient)',
        'React 18',
        'Redux Toolkit',
        'FastAPI',
        'Flask',
    ...
    {
      category: 'AI, LLM & Data Engineering',
      icon: Server,
      skills: [
        ...
        'Vector Embeddings',
        'Guardrails AI',
        'Scikit-learn (Isolation Forest, Decision Trees)',
        'Apache Airflow',
      ],
    },
    {
